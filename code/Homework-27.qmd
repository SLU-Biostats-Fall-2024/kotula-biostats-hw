...
There is no association between plant growth rate and fertilizer treatment (F=2.7906, df=2, p=0.759).
...
Adding one dose of fertilizer treatment did not signifcantly change the plant growth rate (t = 1.624, p = 0.1139).

Does adding 2 doses of fertilizer change the growth rate signficantly from the Control?

Adding 2 doses of fertilizer does significanly change the growth rate of these plants (t = 2.232, p = 0.0325).
...
1 degree of freedom for number of predictors (2) minus one.
